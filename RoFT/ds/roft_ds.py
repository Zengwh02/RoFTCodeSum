...
def run_RoFT(args, model, tokenizer, data_A, data_B, data_C, fast_optimizer, meta_optimizer, fast_scheduler):
    '''
    Run RoFT
    '''
...
def main(args):
    ...
    run_RoFT(args, model, tokenizer, data_loader_a, data_loader_b, data_loader_c, fast_optimizer, meta_optimizer,
             fast_scheduler)
